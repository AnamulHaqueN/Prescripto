...
const MyProfile = () => {
  ...
  const [userData, setUserData] = useState({
    ...
    phone: '+8801 234 5678',
    address: {
      line1: "57th Cross, Dhanmondi ",
      line2: "Circle, Link Road, Dhaka"
    },
    gender: 'Male',
    dob: '2000-01-20'
  })
  ...
  return (
    ...
    <div className='mt-10 ' >
      {
        isEdit
        ? <button className='border border-primay px-8 py-2 rounded-full hover:bg-primary hover:text-white transition-all' onClick={()=>setIsEdit(false)}>Save information</button>
